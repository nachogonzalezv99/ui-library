    ...
    children: (
      <>
        ...
        <Select.Group label="Administration">
          <Select.Item value="administration1">Administration project 1</Select.Item>
          <Select.Item value="administration2">Administration project 2</Select.Item>
          <Select.Item value="administration3">Administration project 3</Select.Item>
        </Select.Group>
        <Select.Separator />
